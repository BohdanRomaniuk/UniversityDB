...
{
    public partial class UFestivalWindow : Window
    {
        //View and Edit
        public UFestivalWindow(UObject elem, FormType type)
        {
        ...
        //Adding
        public UFestivalWindow(UObject elem, FormType type, string className)
        {
