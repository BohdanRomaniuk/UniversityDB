...
{
    public partial class UFacultyWindow : Window
    {
        //View and Edit
        public UFacultyWindow(UObject elem, FormType type)
        {
        ...
        //Adding
        public UFacultyWindow(UObject elem, FormType type, string className)
        {
