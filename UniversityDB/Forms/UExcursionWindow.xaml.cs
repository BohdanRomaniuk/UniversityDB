...
{
    public partial class UExcursionWindow : Window
    {
        //View and Edit
        public UExcursionWindow(UObject elem, FormType type)
        {
        ...
        //Adding
        public UExcursionWindow(UObject elem, FormType type, string className)
        {
