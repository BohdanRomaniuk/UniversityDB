...
{
    public partial class UBuildingWindow : Window
    {
        //View and Edit
        public UBuildingWindow(UObject elem, FormType type)
        {
        ...
        //Adding
        public UBuildingWindow(UObject elem, FormType type, string className)
        {
