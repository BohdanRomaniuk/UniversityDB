...
{
    public partial class USymbolWindow : Window
    {
        //View and Edit
        public USymbolWindow(UObject elem, FormType type)
        {
        ...
        //Adding
        public USymbolWindow(UObject elem, FormType type, string className)
        {
