...
{
    public partial class UDepartmentWindow : Window
    {
        //View and Edit
        public UDepartmentWindow(UObject elem, FormType type)
        {
        ...
        //Adding
        public UDepartmentWindow(UObject elem, FormType type, string className)
        {
