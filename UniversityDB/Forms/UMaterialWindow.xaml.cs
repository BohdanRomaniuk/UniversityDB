...
{
    public partial class UMaterialWindow : Window
    {
        //View and Edit
        public UMaterialWindow(UObject elem, FormType type)
        {
        ...
        //Adding
        public UMaterialWindow(UObject elem, FormType type, string className)
        {
